#!/bin/vbash
# VyOS wireless AP, DHCP, and optional Ethernet WAN setup for ARM64 - Version 8.3-arm64 - dynamic PHY binding and WAN detection
...
if [ -n "$CH5" ]; then
  ...
  # Keep the proven conservative 5 GHz ac path until HE/AX behavior is validated on ARM64 system hardware;
