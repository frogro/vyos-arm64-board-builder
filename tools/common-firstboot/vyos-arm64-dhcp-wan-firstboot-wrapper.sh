...
# Run the image-provided script independently of convenience links in $HOME.
SETUP="$STAGE/dhcp-wan-ssh-setup.sh"
[ -x "$SETUP" ] || fail "First-Boot-Hilfsskript fehlt: $SETUP"
